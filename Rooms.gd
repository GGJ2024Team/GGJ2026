...
const SPAWN_ROOMS = [preload("res://Rooms/SpawnRoom0.tscn")]
const INTERMEDIATE_ROOMS = [preload("res://Rooms/Room0.tscn"), 
                            preload("res://Rooms/Room1.tscn")]
const END_ROOMS = [preload("res://Rooms/EndRoom.tscn")]

const TILE_SIZE: int = 16
const FLOOR_TILE_INDEX: int = 11
const RIGHT_WALL_TILE_INDEX = 16
const LEFT_WALL_TILE_INDEX = 12
...
func _spawn_rooms():
    ...
    for i in num_levels:
        ...
        if i == 0:
            ...
            var exit_tile_pos: Vector2 = previous_room_tilemap.world_to_map(
                previous_room_door.position) + Vector2.UP * 2
            ...
            room.position = previous_room_door.global_position + \
                            ...
                            Vector2.UP * (4 + corridor_height) * TILE_SIZE + \
                            Vector2.LEFT * room_tilemap.world_to_map(room.get_node("Entrance/Position2D2").position).x * TILE_SIZE
